...
main () {
    ...
    if [[ $1 == "attack" || $1 == "all" ]]; then
        ...
        for i in {1..5}; do
            ...
            ./venv/bin/python3 -m main attack $player_attack $enemy_attack > ./scripts/output.txt
    ...
    if [[ $1 == "guard" || $1 == "all" ]]; then
        ...
        for i in {1..5}; do
            ...
            ./venv/bin/python3 -m main guard $player_attack $enemy_attack $player_defense $enemy_defense> ./scripts/output.txt
    ...
    if [[ $1 == "save" || $1 == "all" ]]; then
        ...
        for i in {1..3}; do
            ...
            ./venv/bin/python3 -m main save player $player_name $player_level $player_health
